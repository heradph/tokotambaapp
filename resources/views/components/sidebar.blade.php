<div class="antialiased bg-[#f5f5dc]">
    <nav class="bg-[#f5f5dc] border-b border-gray-200 px-4 py-2.5 fixed left-0 right-0 top-0 z-50">
        <div class="flex flex-wrap justify-between items-center">
            <div class="flex justify-start items-center">
                ...
                <a href="/" class="flex items-center justify-between mr-4">
                    <img src="TokoTamba.svg" class="mr-3 h-12" alt="TokoTamba Logo" />
                    <span class="-mt-1 text-2xl font-semibold whitespace-nowrap text-gray-900 ">TokoTamba</span>
                </a>
            </div>
            <div class="flex items-center lg:order-2">
                <form action="#" method="GET" class="hidden md:block md:pl-2">
                    <label for="topbar-search" class="sr-only">Search</label>
                    <div class="relative md:w-64 md:w-74">
                        <div class="flex absolute inset-y-0 left-0 items-center pl-3 pointer-events-none">
                            <svg class="w-5 h-5 text-[#32620e]" fill="currentColor" viewBox="0 0 20 20"
                                xmlns="http://www.w3.org/2000/svg">
                ...
                <button type="button" data-drawer-toggle="drawer-navigation" aria-controls="drawer-navigation"
                    class="p-2 mr-1 text-[#32620e] rounded-lg md:hidden hover:text-gray-900 hover:bg-gray-100  focus:ring-4 focus:ring-gray-300 ">
                ...
                <button type="button" data-dropdown-toggle="notification-dropdown"
                    class="p-2 mr-1 text-[#32620e] rounded-lg hover:text-gray-900 hover:bg-gray-100  focus:ring-4 focus:ring-gray-300 ">
                ...
                <!-- Dropdown menu -->
                <div class="hidden overflow-hidden z-50 my-4 max-w-sm text-base list-none bg-[#f5f5dc] rounded divide-y divide-gray-100 shadow-lg  rounded-xl"
                    id="notification-dropdown">
                    <div class="block py-2 px-4 text-base font-medium text-center text-gray-700 bg-[#f5f5dc]">
                        Notifications
                    </div>
                    <div>
                        <a href="#" class="flex py-3 px-4 border-b hover:bg-gray-100">
                            ...
                            <div class="pl-3 w-full">
                                <div class="text-[#32620e] font-normal text-sm mb-1.5">
                                    New message from
                        ...
                        <a href="#" class="flex py-3 px-4 border-b hover:bg-[#f5f5dc]">
                            <div class="flex-shrink-0">
                                <img class="w-11 h-11 rounded-full"
                    ...
                    <a href="#"
                        class="block py-2 text-md font-medium text-center text-gray-900 bg-[#f5f5dc] hover:bg-gray-100 ">
                        <div class="inline-flex items-center">
                            <svg aria-hidden="true" class="mr-2 w-4 h-4 text-[#32620e]" fill="currentColor"
                                viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                ...
                <button type="button" data-dropdown-toggle="apps-dropdown"
                    class="p-2 text-[#32620e] rounded-lg hover:text-gray-900 hover:bg-gray-100  focus:ring-4 focus:ring-gray-300 ">
                    <span class="sr-only">View notifications</span>
                    <!-- Icon -->
                ...
                <div class="hidden overflow-hidden z-50 my-4 max-w-sm text-base list-none bg-[#f5f5dc] rounded divide-y divide-gray-100 shadow-lg rounded-xl"
                    ...
                    <div class="grid grid-cols-3 gap-4 p-4">
                        ...
                        <a href="/" class="block p-4 text-center rounded-lg hover:bg-gray-100  group">
                            <svg aria-hidden="true"
                                class="mx-auto mb-1 w-7 h-7 text-gray-400 group-hover:text-gray-500" fill="none"
                ...
                <button type="button"
                    ...
                    <img class="w-8 h-8 rounded-full" src="user.webp" alt="user photo" />
                </button>
                <!-- Dropdown menu -->
                <div class="hidden z-50 my-4 w-56 text-base list-none bg-[#f5f5dc] rounded divide-y divide-gray-100 shadow rounded-xl"
                    id="dropdown">
                    <div class="py-3 px-4">
                    ...
                    <ul class="py-1 text-gray-" aria-labelledby="dropdown">
                        <li>
                    ...
                    <ul class="py-1 text-gray-" aria-labelledby="dropdown">
                        <li>
                            <a href="#" class="flex items-center py-2 px-4 text-sm hover:bg-gray-100"><svg
                                    class="mr-2 w-5 h-5 text-[#32620e]" fill="currentColor" viewBox="0 0 20 20"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd"
                                        d="M3.172 5.172a4 4 0 015.656 0L10 6.343l1.172-1.171a4 4 0 115.656 5.656L10 17.657l-6.828-6.829a4 4 0 010-5.656z"
                                        clip-rule="evenodd"></path>
    ...
    <aside
        ...
        <div class="overflow-y-auto py-5 px-3 h-full bg-[#f5f5dc]">
            <form action="#" method="GET" class="md:hidden mb-2">
                ...
                <div class="relative">
                    ...
                    <input type="text" name="search" id="sidebar-search" value = {{ request('search') }}
            ...
            <ul class="space-y-2">
                <li>
                    <a href="/"
                        ...
                        <svg aria-hidden="true"
                            class="w-6 h-6 text-[#32620e] transition duration-75 group-hover:text-gray-900"
                            fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                ...
                <li>
                    <button type="button"
                        ...
                        <svg aria-hidden="true"
                            class="flex-shrink-0 w-6 h-6 text-[#32620e] transition duration-75 group-hover:text-gray-900"
                            fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd"
                                d="M10 2a4 4 0 00-4 4v1H5a1 1 0 00-.994.89l-1 9A1 1 0 004 18h12a1 1 0 00.994-1.11l-1-9A1 1 0 0015 7h-1V6a4 4 0 00-4-4zm2 5V6a2 2 0 10-4 0v1h4zm-6 3a1 1 0 112 0 1 1 0 01-2 0zm7-1a1 1 0 100 2 1 1 0 000-2z"
                                clip-rule="evenodd"></path>
                        </svg>
                        <span class="flex-1 ml-3 text-left whitespace-nowrap">Keranjang</span>
                        <svg aria-hidden="true" class="w-6 h-6" fill="currentColor" viewBox="0 0 20 20"
                            xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd"
            ...
            <div class="pt-5 mt-5 space-y-2 border-t border-gray-500 "></div>
        </div>
    </aside>
</div>
